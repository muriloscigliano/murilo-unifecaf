...
export function WorkflowStep({
  ...
  return (
    <div
      className={`p-7 rounded-3xl border border-[var(--border)]/60 ${variantStyles[variant]} transition-all hover:scale-[1.01]`}
    >
      <div className="flex items-start gap-5">
        <Icon className="w-7 h-7 flex-shrink-0 text-[var(--muted-foreground)] stroke-[1.5] mt-0.5" />
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-3">
            <span className="text-sm font-mono text-[var(--muted-foreground)] bg-[var(--muted)]/50 px-2 py-1 rounded-lg">
              {number}
            </span>
